...
public class MarkdownPage extends AbstractPage {
    public MarkdownPage(String fileType, String extName, String contextPath, FilePreviewInfo info, FilePreviewService filePreviewService, FilePreviewProperties properties) {
    ...
    public ServerResponse build() {
        ...
        return writePage("markdown.ftl", data);
    }
}
