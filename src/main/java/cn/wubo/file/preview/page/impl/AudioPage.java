...
public class AudioPage extends AbstractPage {
    public AudioPage(String fileType, String extName, String contextPath, FilePreviewInfo info, FilePreviewService filePreviewService, FilePreviewProperties properties) {
    ...
    public ServerResponse build() {
        ...
        return writePage("audio.ftl", data);
    }
}
