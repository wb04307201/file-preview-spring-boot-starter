...
public class BpmnPage extends AbstractPage {
    public BpmnPage(String fileType, String extName, String contextPath, FilePreviewInfo info, FilePreviewService filePreviewService, FilePreviewProperties properties) {
    ...
    public ServerResponse build() {
        ...
        return writePage("bpmn.ftl", data);
    }
}
