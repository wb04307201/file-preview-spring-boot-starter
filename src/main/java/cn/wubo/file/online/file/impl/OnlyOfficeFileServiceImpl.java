...
@Slf4j
public class OnlyOfficeFileServiceImpl implements IFileService {
    ...
    public void doCovert(File file, ConvertInfoDto convertInfoDto) {
        ...
        log.debug("转换线程-----covertFilePath:{}", covertFilePath);
